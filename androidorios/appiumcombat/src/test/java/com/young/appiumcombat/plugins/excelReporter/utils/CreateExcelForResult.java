...
//			        result/screenshots/Android_TaxGuidePage_001_UiCheck_test/
//			        result/screenshot/Android_TaxGuidePage_001_UiCheck_test
			        if(fileList!=null){
	...
	//			        File png = new File("result/screenshot/"+className+"/"+caseName+".png");
				        if(png.exists()){
				        	//设置截图图片，这是超链接 result/screenshots/Android_TaxGuidePage_001_UiCheck_test/DiscountRecordUiCheck_1494488254235.png
