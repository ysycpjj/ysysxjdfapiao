...
public class LogConfiguration {
	    ...
	    /**取得模块名字,类名前加了环境，故应该去第一个_和第二个_中间部分去掉page,*/
	    public static String getFunctionName(String fileName){
			String functionName = null; 
			int firstUndelineIndex =fileName.indexOf("_") ; 
			int secondUndelineIndex =fileName.substring(firstUndelineIndex+1).indexOf("_")+firstUndelineIndex+1; 
//			functionName = fileName.substring(0, firstUndelineIndex-4);
			functionName = fileName.substring(firstUndelineIndex+1, secondUndelineIndex-4);
			return functionName;
